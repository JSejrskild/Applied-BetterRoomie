...
# Plotting frustration, and roomieship
```{r}
roomie_experiment_data$A403 <- as.numeric(roomie_experiment_data$A403)
roomie_experiment_data$A402 <- as.numeric(roomie_experiment_data$A402)
roomie_experiment_data$A404 <- as.numeric(roomie_experiment_data$A404)

roomie_experiment_data$flipA402 <- 6-(as.numeric(roomie_experiment_data$A402))
roomie_experiment_data$flipA403 <- 6-(as.numeric(roomie_experiment_data$A403))
...
```{r}
ggplot(roomie_experiment_data, aes( x = flipA402, #Frustration
                  y = flipA403,
                  fill= A404,
                  colour=A404))+ # Roomieship
  ylim(0,5)+xlim(0,5)+
